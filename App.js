...
export default function App() {
  const myLocalFlashMessageapp = useRef(null);
  ...
  const showOFfline = () => {
    if (myLocalFlashMessageapp && myLocalFlashMessageapp.current) {
      myLocalFlashMessageapp.current.showMessage({
          ...
          <NetworkConsumer>
            {({ isConnected }) =>
              isConnected ? (
                ...
                <>
                  <FlashMessage ref={myLocalFlashMessageapp} position="top" />
                  {showOFfline()}
                </>
              )
            }
