...
import {View, ScrollView,  Text, Button, StyleSheet,TextInput, TouchableOpacity, Image,StatusBar} from 'react-native';
  ...
  <Grid style={{flex:1, flexDirection:'row', borderWidth:0, borderColor:'red'}}>
    <Row   style={{ padding:10}}>
      ...
      <Col size={100}  style={{borderWidth:2,borderColor:'#ddd', borderRadius:10, padding:3}}>    
        <PickerIOS mode="dialog" selectedValue={stateId} onValueChange={(itemValue, itemIndex) => {getService(itemValue);}} >
          <PickerIOS.Item label="Select State" value="" />
