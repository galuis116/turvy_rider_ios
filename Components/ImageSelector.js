    ...
    <>
      ...
      >
        ...
        <ActivityIndicator
          size="large"
          color="#3f78ba"
          animating={showloadimg}
        />
        {/* <View
          style={[
            imageUploaderStyles.uploadBtnContainer,
            {
              width: props.btnwidth ? props.btnwidth : "100%",
              height: props.btnheight ? props.btnheight : "25%",
            },
          ]}
        >
          <Grid>
        ...
        >
          <Grid>
            <Row style={{ paddingTop: 5, backgroundColor: "#fff", height: 55 }}>
              <Col size={6}>
                <TouchableOpacity
                  onPress={addImage}
                  style={imageUploaderStyles.uploadBtn}
      ...
      >
        <View style={{ backgroundColor: "rgba(0, 0, 0, 0.5)", flex: 1 }}>
          <Grid>
            <Row
              style={{ paddingTop: 20, backgroundColor: "#fff", height: 100 }}
            >
              <Col size={6}>
                <TouchableOpacity
                  onPress={addImage}
