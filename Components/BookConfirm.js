                    ...
                    {servicetypes.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          <TouchableOpacity
                            onPress={() =>
                              this._onPressService(item, faresmapValue)
                            }
      ...
      <View style={styles.container}>
        ...
        <MapboxGL.MapView
          ...
          onDidFinishRenderingMapFully={(index) => {
            ...
            if (this.props.route.params.inputData) {
              let totrec = Object.keys(
                this.props.route.params.inputData
              ).length;
              totrec = totrec - 2;
              if (Object.keys(this.props.route.params.inputData).length > 0) {
                this.props.route.params.inputData.map((item, key) => {
            ...
            fetch(
              ...
              .then((result) => {
                ...
                console.log(
                  "COORDINATES ARRAY=========",
                  Object.values(result.routes[0].geometry.coordinates)
                );
                this.setState(
                  {
                ...
                >
                  ...
                  >
                    ...
                    <Row size={6}>
                      ...
                      <Col size={25}>
                        <Text style={styles.label}>
                          A${this.state.longpressdata.price_per_minute}
                        </Text>
                      </Col>
                    </Row>
