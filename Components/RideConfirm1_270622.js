        ...
        if (doc.exists) {
          ...
          this.setState(
            ...
            () => {
              ...
              console.log(
                " ORGIN SET INITAL " + JSON.stringify(this.state.driverLocation)
              );
              console.log(
                " ORGIN SET INITAL LONGITUDE " +
                  this.state.driverLocation.longitude
              );
              console.log(
                " ORGIN SET INITAL Lati " + this.state.driverLocation.latitude
              );
            }
          );
        } else {
        ...
        >
          ...
          >
            <MapboxGL.LineLayer
              ...
              style={{ lineColor: "#468DDf", lineWidth: 12 }}
            />
          </MapboxGL.ShapeSource>
          <MapboxGL.ShapeSource
