	    ...
	    <Surface style={stylesBg.surface}>
          <Grid style={{width:'100%'}}>
          	<Row size={20} style={{height:65}}>
               ...
               <Row size={50} style={{height:65}}>
                <View style={styles.btnBox}>
               	 <TouchableOpacity onPress={()=>{ this.props.navigation.navigate('MyTransaction'); }} style={styles.contentBtn} >
					    	  		
                      <LinearGradient  
                        style={styles.priBtn}       
                        colors={['#2270b8', '#74c0ee']}
                        end={{ x: 1.2, y: 1 }}>               
                          <Text style={styles.priBtnTxt}>View Transactions</Text>
                      </LinearGradient>
					        	</TouchableOpacity> 
                    </View>
               </Row>
               <Row size={70} style={{height:65}}>
                <View style={styles.btnBox}>
                 <TouchableOpacity onPress={()=>{ this.props.navigation.navigate('AddPayment'); }}  style={styles.contentBtn} >
                 <LinearGradient  
                  style={styles.priBtn}       
                  colors={['#2270b8', '#74c0ee']}
                  end={{ x: 1.2, y: 1 }}>               
                    <Text style={styles.priBtnTxt}>Add Payment Method</Text>
                </LinearGradient>
		        	</TouchableOpacity> 
              </View>
              </Row>
