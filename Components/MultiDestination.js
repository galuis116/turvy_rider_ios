...
export default class MultiDestination extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      step: 1,
  ...
  _onPressDone = () => {
    ...
    if (
      Object.keys(this.state.stopmainlnglat).length > 0 &&
            ...
            if (
              ...
              if (currIND == 0) {
                if (this.refinput0.current) {
                  ...
                  this.refinput0.current.setNativeProps({
                    text: rowData.description,
                  });
                }
                ...
                if (this.refinput1.current) {
                  ...
                  this.refinput1.current.setNativeProps({
                    text: rowData.description,
                  });
                }
      ...
      <PaperProvider theme={theme}>
        ...
        >
          <Grid>
            <Row>
              <Col>
                <Image style={{ width: 64, height: 64 }} source={imagestopwt} />
              </Col>
            </Row>
            <Row>
              <Col>
                <Text style={{ fontSize: 25 }}>
                  Please keep stop to 3 minutes or less
                </Text>
              </Col>
            </Row>
            <Row>
              <Col>
                <Text style={{ letterSpacing: 2, lineHeight: 20 }}>
                  As a courtesy for your driver's time, please limit each stop
                  minutes or less, otherwise your fare may change.{" "}
                </Text>
              </Col>
            </Row>
