        ...
        >
          <Surface style={stylesBg.surface}>
            <Row style={{ paddingTop: 15 }}>
              ...
              <Col size={4}>
                <Caption style={{ fontSize: 14, textAlign: "right" }}>
                  {" "}
                ...
                {item.item.origin_lat && item.item.origin_lng ? (
                  ...
                  >
                    ...
                    <MapView.Marker.Animated
                      ...
                      coordinate={{
                        latitude: item.item.destination_lat,
                        longitude: item.item.destination_lng,
                      }}
                    ></MapView.Marker.Animated>

                    {item.item.origin_lat &&
                    item.item.origin_lng &&
                    item.item.destination_lng &&
                    item.item.destination_lat ? (
                      <>
                        <MapViewDirections
                          region={"AU"}
                          origin={{
  ...
  render() {
    return (
      <PaperProvider theme={theme}>
        ...
        Object.keys(this.state.paymentlist).length > 0 ? (
          <FlatList
