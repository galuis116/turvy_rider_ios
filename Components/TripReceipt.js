...
export default class TripReceipt extends React.Component{    
	...
	getseatcost = () =>{
	  if(this.state.surgeinfo.baby_seat_charge > 0){
	  		return (<Row size={24} style={{justifyContent:'center',alignItems:"center"}}>
      				<Col size={8}><Text>Baby Seat Charge </Text></Col>
						<Col size={4}><Text style={{textAlign:'right'}}>A${this.state.surgeinfo.baby_seat_charge}</Text></Col>
					</Row>);
	  }else if(this.state.surgeinfo.pet_charge > 0){
	  	return (<Row size={24} style={{justifyContent:'center',alignItems:"center"}}>
      				<Col size={8}><Text>Pet Charge</Text></Col>
						<Col size={4}><Text style={{textAlign:'right'}}>A${this.state.surgeinfo.pet_charge}</Text></Col>
				</Row>);
	  }else{
	  		return null;
	  }
    ...
    render(){
      			...
      			<Row size={20}>
					...
					<Row size={24} style={{justifyContent:'center',alignItems:"center"}}>
      				<Col size={8}><Text>GST </Text></Col>
						<Col size={4}><Text style={{textAlign:'right'}}>A${this.state.surgeinfo.gst_amt}</Text></Col>
					</Row>
      	...
      	<Row size={5} style={{paddingHorizontal:20,paddingVertical:10}}>
      	...
      	</Row>
		{
			...
			&&
		  <Row size={5} style={{paddingHorizontal:20,paddingVertical:10,borderBottomWidth:1,borderBottomColor:'silver'}}>
      		<Col size={8}><Text>Tip </Text></Col>
				<Col size={4}><Text style={{fontWeight:'bold',fontSize:18,textAlign:'right'}}>A${this.state.selectedTrip.tip_amt}</Text></Col>
      	</Row>
		}
			</>)
			: 			
      	...
      	<TouchableOpacity onPress={() =>{ this.gotopdf() }} style={{flexDirection:'row',alignItems:'center',padding:10}}>
      	...
      	<Row  size={5} >
      	<Col>
      	<TouchableOpacity onPress={() =>{ this.sendEmail() }} style={{flexDirection:'row',alignItems:'center',padding:10}}>
