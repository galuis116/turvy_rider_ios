...
export default class DeleteAccount extends React.Component {
    ...
    componentWillUnmount = () => {
     ...
     deleteAccount = () => {
         fetch(DOMAIN+'api/rider/delete-account',{
            method: 'POST',
            headers : {
			        	...
			        	<Divider orientation="horizontal" />
			        	 ...
			        	 <>
                                ...
                                */}
                                      <View style={{flex:1}}>
                                        <Grid>
                                              <Row style={{height:moderateScale(200)}}>
                                                <Col style={{alignItems:'center',margin:moderateScale(10)}}>
                                                   <Text style={{fontSize:20,textAlign:'center'}}>Are you sure to delete your Account?</Text>
                                                    ...
                                                    <Text style={{alignItems:'center',fontSize:16,color:'gray',padding:15,lineHeight:25,paddingHorizontal:15}}>It will delete your account permanently.</Text>
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col>                               
