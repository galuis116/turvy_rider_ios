...
export default class Createaccount extends React.Component {
  ...
  async submit() {
    ...
    if (
      ...
      formData.append("partner_id", this.state.planner);
  ...
  _renderItem = (item) => {
    ...
    return (
      <View style={styles.item}>
        <Text style={stylesdp.textItem}>{item.organization}</Text>
      </View>
    );
  };
          ...
          <View style={styles.content}>
            <View style={{ flexDirection: "row" }}>
              <View style={{ width: "100%" }}>
                <Input
                  ...
                  inputStyle={[
                    styles.inputStyle,
                    { borderColor: this.state.firstNameError ? "red" : "#ddd" },
                  ]}
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ width: "100%" }}>
                <Input
                  ...
                  inputStyle={[
                    styles.inputStyle,
                    { borderColor: this.state.lastNameError ? "red" : "#ddd" },
                  ]}
                  inputContainerStyle={styles.inputContainerStyle}
                  value={this.lastName}
                  onChangeText={(value) => {
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ width: "100%" }}>
                <Input
                  ...
                  inputStyle={[
                    styles.inputStyle,
                    { borderColor: this.state.statepassword ? "red" : "#ddd" },
                  ]}
                  inputContainerStyle={styles.inputContainerStyle}
              ...
              <View style={{ width: "100%" }}>
                <Input
                  ...
                  inputStyle={[
                    styles.inputStyle,
                    {
                      borderColor: this.state.errorConfPassword
                        ? "red"
                        : "#ddd",
                    },
                  ]}
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ width: "100%" }}>
                <Input
                  ...
                  inputStyle={[
                    styles.inputStyle,
                    { borderColor: this.state.errorEmail ? "red" : "#ddd" },
                  ]}
                  inputContainerStyle={styles.inputContainerStyle}
                  value={this.email}
            ...
            <View
              style={[
                ...
                { borderColor: this.state.errorPartner ? "red" : "#ddd" },
              ]}
            >
              <Dropdown
                ...
                data={this.state.partners.length > 0 ? this.state.partners : []}
                labelField="organization"
                valueField="id"
                value={this.state.partnerItem}
                onChange={(item) => {
                  this.setState({ planner: item.id, partnerItem: item }, () => {
                    if (item.id == "") {
                      this.setState({
                        errorPartner: "Please choose Partner.",
                      });
                    } else {
                      this.setState({
                        errorPartner: "",
