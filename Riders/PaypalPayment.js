...
export default class PaypalPayment extends React.Component {
   ...
   async stateChng(navState){
        ...
        if(title == "Sucess" || url.includes('https://www.turvy.net/payments/rider/paypal/success.php')){
      ...
      .catch((error) => console.error(error));
        ...
        this.props.navigation.replace('PaymentMethods',this.state);
    } 
              
            //after payment done 
            //from here we can update our database.
            
        }else if(title == "Cancel" || url.includes('https://www.turvy.net/payments/rider/paypal/cancel.php') ){
        	   this.props.navigation.replace('PaymentMethods',this.state);
        }  
    }
