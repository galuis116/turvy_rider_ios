			...
			method: 'GET',
 			...
 			return response.json();
  			...
  			for (let item of result.data) {
  				...
  				if(item.id === this.state.partner_id){
        					...
        					<View style={{flex:1}}>
				          	...
				          	<Dropdown
					            ...
					            onChange={(item) => {
						        	...
						        	this.setState({partner_id:item.id,
						        		partnerItem:item},()=>{
				        					if(item.id == ''){
				        						this.setState({
					        	...
					        	{/* <PickerIOS style={{ height: 55, width: '100%',backgroundColor: 'transparent',color:'#8c8c8c',overflow:'hidden'}} 
					        	 itemStyle={{marginTop:-80,backgroundColor:'transparent'}}
					        	...
					        	<PickerIOS.Item label="Select Partner" value="" style={{backgroundColor:'transparent'}} />
